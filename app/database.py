...
def initialize_database_schema():
    ...
    try:
        ...
        CREATE TABLE Productos ( idProducto INT IDENTITY(1,1) PRIMARY KEY, Codigo NVARCHAR(50) NOT NULL UNIQUE, CodigoBarra NVARCHAR(50) NULL, NombreProducto NVARCHAR(200) NOT NULL UNIQUE, idCategoria INT NOT NULL, Precio DECIMAL(10, 2) NOT NULL, Stock INT NOT NULL DEFAULT 0, Activo BIT NOT NULL DEFAULT 1, CONSTRAINT FK_Productos_Categorias FOREIGN KEY (idCategoria) REFERENCES Categorias(idCategoria) );
        CREATE UNIQUE INDEX UQ_Productos_CodigoBarra ON Productos(CodigoBarra) WHERE CodigoBarra IS NOT NULL;
