...
# Usamos '..' para subir un nivel (de 'pages' a 'app') y luego entrar a 'auth'
...
class UserFormDialog(QDialog):
    def __init__(self, user_id=None, user_data=None, on_success=None, parent=None):
        ...
        self.user_data = user_data # Para rellenar el formulario de edición
        self.on_success = on_success
        self.roles_map = {} # Para mapear Nombre Rol -> idRol
    ...
    def populate_form(self):
        ...
        # Encontrar el rol en el QComboBox
    ...
    def handle_save(self):
        ...
        try:
            if self.user_id:
                ...
                new_password = password if password else None # Solo pasa la pass si no está vacía
            ...
            if success:
                ...
                if self.on_success:
                    self.on_success() # Refresca la tabla de usuarios
